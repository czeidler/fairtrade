...
SRCS= fairtrade.cpp  main.cpp stock.cpp timer.cpp gui/mainview.cpp gui/mainwindow.cpp gui/productsview.cpp gui/sellview.cpp gui/YabStackView.cpp gui/column/ColorTools.cpp gui/column/ColumnListView.cpp gui/column/ColumnTypes.cpp gui/layout/blayout.cpp sqlite/SQLConnection.cpp
...
LIBS= be media translation sqlite3 $(STDCPPLIBS)
...
SYSTEM_INCLUDE_PATHS = gui gui/column sqlite gui/layout ConfigApp
...
include /boot/common/develop/etc/makefile-engine
